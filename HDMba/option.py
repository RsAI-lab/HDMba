...
# model
# parser.add_argument('--net', type=str, default='AACNet')
# parser.add_argument('--net', type=str, default='AIDTransformer')
# parser.add_argument('--net', type=str, default='DehazeFormer')
parser.add_argument('--net', type=str, default='HDMba')

parser.add_argument('--bs', type=int, default=2, help='batch size')
parser.add_argument('--crop_size', type=int, default=64, help='Takes effect when using --crop')
parser.add_argument('--no_lr_sche', action='store_true', help='no lr cos schedule')
parser.add_argument('--perloss',  help='spec_loss')
