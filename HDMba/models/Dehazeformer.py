...
class DehazeFormer(nn.Module):
	def __init__(self, in_chans=305, out_chans=306, window_size=8,
	# def __init__(self, in_chans=7, out_chans=8, window_size=8,
	# def __init__(self, in_chans=4, out_chans=5, window_size=8,
	...
	def forward(self, x):
		...
		K, B = torch.split(feat, (1, 305), dim=1)
		# K, B = torch.split(feat, (1, 7), dim=1)
		# K, B = torch.split(feat, (1, 4), dim=1)
