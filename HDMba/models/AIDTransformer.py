...
class InputProj(nn.Module):
    def __init__(self, in_channel=305, out_channel=64, kernel_size=3, stride=1, norm_layer=None,act_layer=nn.LeakyReLU):
        super().__init__()
...
class OutputProj(nn.Module):
    def __init__(self, in_channel=64, out_channel=305, kernel_size=3, stride=1, norm_layer=None,act_layer=None):
        super().__init__()
        self.proj = nn.Sequential(
            nn.Conv2d(in_channel, out_channel, kernel_size=3, stride=stride, padding=kernel_size//2),
        )
...
class AIDTransformer(nn.Module):
    # def __init__(self, img_size=64, in_chans=4,
    # def __init__(self, img_size=64, in_chans=7,
    def __init__(self, img_size=64, in_chans=305,
...
if __name__ == '__main__':
    ...
    # mcplb = AIDTransformer().cuda()
    # out = mcplb(x)
    # summary(mcplb.cuda(), (305, 64, 64))